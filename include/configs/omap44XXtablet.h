...
#define CONFIG_JORJIN_APM_HACKS	1    /* Enable APM hacks */
...
#else
//#define CONFIG_FLASH_UBOOT
//#define CONFIG_AUTO_BOOT
#define CONFIG_BOARD_TEST
#define CONFIG_LEDS_INDICATOR
#define CONFIG_DIEID_INFO
#define CONFIG_BOOTDELAY         0
...
#ifdef CONFIG_JORJIN_APM_HACKS
#define CONFIG_EXTRA_ENV_SETTINGS\
        "sdbootcmd=mmcinit; fatload mmc 0 0x81c00000 uImage; bootm 0x81c00000\0"\
        "sdbootargs=root=/dev/mmcblk1p2 rw rootdelay=2 init=/init SD_BOOT\0"

#define APM_HACK_ADDR	0x80001000
#endif
...
/* Fastboot variables */
#define CFG_FASTBOOT_TRANSFER_BUFFER (PHYS_SDRAM_1 + SZ_32M)
#define CFG_FASTBOOT_TRANSFER_BUFFER_SIZE (SZ_512M - SZ_32M)
...
#define CONFIG_CUSTOM_CHARGE_MODE
#ifdef CONFIG_CUSTOM_CHARGE_MODE
#define USE_1340MAH_BAT
#ifdef USE_1340MAH_BAT
#define MAX_CHRG_CURRENT	0x40 /* 950mA with 68mOhm */
#define CHRG_CURRENT		0x20 /* 950mA with 68mOhm */
#define CHRG_VOLTAGE		0x78 /* 4000mV */
#define CHRG_THRESHOLD		3600 /* 3600mV */
#else
#define MAX_CHRG_CURRENT	0x00 /* 550mA with 68mOhm */
#define CHRG_CURRENT		0x00 /* 550mA with 68mOhm */
#define CHRG_VOLTAGE		0x78 /* 4000mV */
#define CHRG_THRESHOLD		3600 /* 3600mV */
#endif
#endif

/* Shipping Mode Configurations */
#define CONFIG_SHIPPING_MODE
#ifdef CONFIG_SHIPPING_MODE
#define SHIP_MOD_MMC_SLOT	1
#define SHIP_MOD_MMC_OFFSET	0x80
#define SHIP_MOD_DDR_OFFSET	0x82000000
#endif

/* S/N Flashing Configurations */
#define CONFIG_CUSTOM_SN_FLASH
#ifdef CONFIG_CUSTOM_SN_FLASH
#define SN_MMC_SLOT		1
#define SN_MMC_PTN		"firmware"
#define SN_SIZE			18
#define SN_CHKSUM_BIT		16
#define SN_CHKSUM_SIZE		((SN_CHKSUM_BIT/8)+1)
#define SN_ENCKEY		"\x09\x5e\x42\x5a\x25\x2b"
#define SN_ENCKEY_SIZE		(sizeof(SN_ENCKEY))
#endif

/* Language Flashing Configurations */
#define CONFIG_CUSTOM_LANGUAGE_FLASH
#ifdef CONFIG_CUSTOM_LANGUAGE_FLASH
#define LANG_MMC_SLOT		1
#define LANG_MMC_PTN		"firmware"
#define LANG_MMC_OFFSET		64
#define DEFAULT_LANG		"en_US"
#define LANG_SIZE		(sizeof(DEFAULT_LANG))
#endif

/* Timezone Flashing Configurations */
#define CONFIG_CUSTOM_TIMEZONE_FLASH
#ifdef CONFIG_CUSTOM_TIMEZONE_FLASH
#define TIME_MMC_SLOT		1
#define TIME_MMC_PTN		"firmware"
#define TIME_MMC_OFFSET		80
#define DEFAULT_TIME		"GMT+00:00"
#define TIME_SIZE		(sizeof(DEFAULT_TIME))
#endif

/* Debug flag for ADC1(Battery Temperature) */
//#define CONFGI_CHRG_ADC1_DEBUG

/* Config flag for long pressed poweron */
#define CONFIG_LONG_PRESSED_PWRON

//#define CONFIG_COMPACT_I2C_SETTING

#define CONFIG_KEEP_DISPLAY_ALIVE

/* Config flag for battery overcurrent deactivation */
#define CONFIG_BAT_OVRCURR_HACK
